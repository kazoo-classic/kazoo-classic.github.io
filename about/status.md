...
- **Database Change to PostgreSQL**  
  The project prefers PostgreSQL over KazooDB/MySQL for subscriber data. KazooDB is not opensource and has performance issues. This was made possible by the fantasic work of `ruhnet`
...
- **Fail2Ban & Security**  
  Integration of filtering modules to handle SIP scanners and flood attempts is being tested by contributors like `Felipe Mateo`.  
